...
const PlayerClues = ({data}) => {
  ...
  return(
    ...
    <div className='bg-black   pb-20 flex flex-col items-center justify-center '>
      ...
      <Image src={data?.Image} className=" w-[400px] md:w-[700px] p-4 rounded-3xl mt-10 md:ml-12  " height={0}  width={400}  alt="player image"  blurDataURL={data?.Image}/>
